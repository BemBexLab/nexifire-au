...
export const metadata = createPageMetadata({
  ...
  description:
    "Learn how NexiFire's parent organisation guides specialised brands in publishing, tech, and marketing to deliver focused, scalable growth.",
  pathname: "/about",
});
    ...
    <section className="relative overflow-hidden bg-white">
      ...
      <WhoWeAre
        ...
        paragraphs={[
          ...
          "NexiFire is a multi dimensional growth ecosystem built on the principle of specialised excellence. Instead of managing everything in one place, we have built a group of focused brands, each one specialised in a specific area.",
          "This means every challenge, whether it is book services, writing, polishing it, working on book promotion and optimisation on different platforms, content development for websites, website development on different e-commerce platforms, or marketing, is handled by experts who do that one thing exceptionally well and in an organised way.",
          "As the parent company, our role is to guide the strategy and bring everything together. We give our brands the direction, systems, and support they need to deliver real results. We connect strategy with execution. That means we do not just plan, we build, launch, and optimise systems that actually grow your business. At NexiFire, we believe growth is not one dimensional. It comes from combining strong storytelling, reliable technology, and high performing marketing systems. Whether you're starting something new or scaling an existing business, we make sure every step is clear, every system is built to scale, and every result can be measured.",
        ]}
        image={{
      ...
      <BuildSmarter
        ...
        description={`Stop searching for a vendor and start partnering with an ecosystem. Let the NexiFire Group provide the specialised expertise and strategic infrastructure your brand needs to lead its industry.`}
